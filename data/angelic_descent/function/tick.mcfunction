...
execute as @e[tag=angelic_descent_rift] run execute at @s run execute if entity @e[type=item,distance=..1,nbt={Item:{id:"minecraft:echo_shard",count:1}}] run kill @s
