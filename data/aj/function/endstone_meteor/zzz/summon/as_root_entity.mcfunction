...
data modify storage animated_java:temp entry.data.blueprint_id set value "aj:endstone_meteor"
data modify storage animated_java:temp entry.data.rig_hash set value "51bfcbe0e8b4829026d3a8fb1ac53dd43e9a625fb886f60387abc26938762b2d"
tp @s ~ ~ ~ ~ ~
execute on passengers if entity @s[tag=aj.endstone_meteor.node.meteor] run function aj:endstone_meteor/zzz/summon/as_node/meteor
data modify storage animated_java:temp entry.data.uuids append from storage animated_java:gu out
data modify storage animated_java:temp entry.data.uuids_by_name.meteor set from storage animated_java:gu out
function aj:endstone_meteor/zzz/set_default_pose
# Data Manager: Write
function animated_java:global/data_manager/write with storage animated_java:temp args
execute if data storage animated_java:temp args.variant run function aj:endstone_meteor/zzz/summon/zzz/variant_arg/no_variants_warning
