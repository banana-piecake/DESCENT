...
data modify storage animated_java:temp entry.data.blueprint_id set value "aj:lil_fiend_rune"
data modify storage animated_java:temp entry.data.rig_hash set value "a39740f7b0e6b789b5242095a314b5b343e085d66f44c73c31ea426ee1ab3f22"
tp @s ~ ~ ~ ~ ~
execute on passengers if entity @s[tag=aj.lil_fiend_rune.node.bone] run function aj:lil_fiend_rune/zzz/summon/as_node/bone
data modify storage animated_java:temp entry.data.uuids append from storage animated_java:gu out
data modify storage animated_java:temp entry.data.uuids_by_name.bone set from storage animated_java:gu out
function aj:lil_fiend_rune/zzz/set_default_pose
# Data Manager: Write
function animated_java:global/data_manager/write with storage animated_java:temp args
execute if data storage animated_java:temp args.variant run function aj:lil_fiend_rune/zzz/summon/zzz/variant_arg/no_variants_warning
