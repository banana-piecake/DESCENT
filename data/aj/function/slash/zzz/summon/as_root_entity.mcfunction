...
data modify storage animated_java:temp entry.data.blueprint_id set value "aj:slash"
data modify storage animated_java:temp entry.data.rig_hash set value "ebd55e93cd823ad0f623465a0f778aafae5a776d42172aa3876a893d5a22fcbd"
tp @s ~ ~ ~ ~ ~
execute on passengers if entity @s[tag=aj.slash.node.bone] run function aj:slash/zzz/summon/as_node/bone
data modify storage animated_java:temp entry.data.uuids append from storage animated_java:gu out
...
execute if data storage animated_java:temp args.variant run function aj:slash/zzz/summon/variant_arg/process with storage animated_java:temp args
execute if score #success aj.i matches 0 run return fail
execute if data storage animated_java:temp args.animation run function aj:slash/zzz/summon/animation_arg/process with storage animated_java:temp args
execute if score #success aj.i matches 0 run return fail
