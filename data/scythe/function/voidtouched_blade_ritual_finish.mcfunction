...
execute at @s run summon ominous_item_spawner ~ ~ ~ {spawn_item_after_ticks:60,item:{id:"minecraft:netherite_sword",count:1,components:{"minecraft:item_model":"scythe:voidtouched_blade","minecraft:item_name":{"color":"#C4B3FF","text":"Voidtouched Blade"},"minecraft:enchantments":{"scythe:end_aspect":1,"scythe:void_cull":1},"minecraft:custom_data":{voidtouched:"blade"},"minecraft:blocks_attacks":{block_sound:"entity.zombie.attack_iron_door",disabled_sound:"entity.zombie.attack_iron_door"}}}}
