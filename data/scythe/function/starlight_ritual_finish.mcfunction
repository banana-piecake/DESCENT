...
execute at @s run summon ominous_item_spawner ~ ~ ~ {spawn_item_after_ticks:100,item:{id:"minecraft:crossbow",count:1,components:{"minecraft:item_model":"starlight:starlight","minecraft:item_name":{"color":"#CF99FF","text":"Starlight"},"minecraft:enchantments":{"angelic_descent:starlight":1},"minecraft:lore":["Your final reward."]}}}
