...
execute at @s run summon ominous_item_spawner ~ ~ ~ {spawn_item_after_ticks:30,item:{id:"minecraft:diamond_boots",count:1,components:{"minecraft:enchantments":{"scythe:sculk_cling":1},"minecraft:item_name":"Echo Boots","minecraft:trim":{material:"minecraft:diamond",pattern:"minecraft:silence"}}}}
