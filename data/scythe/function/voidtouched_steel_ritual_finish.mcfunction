...
execute at @s run summon ominous_item_spawner ~ ~ ~ {spawn_item_after_ticks:20,item:{id:"minecraft:iron_ingot",count:1,components:{"minecraft:item_model":"scythe:voidtouched_steel","minecraft:item_name":{text":"Voidtouched Steel"},"minecraft:custom_data":{descent:"voidtouched_steel"}}}}
