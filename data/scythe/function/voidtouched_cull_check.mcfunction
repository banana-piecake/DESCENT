...
execute if score @s descent_voidtouched_health_ratio_check matches ..250 run execute at @s run playsound angelic_descent:subspace_explode hostile @a[distance=0..16] ~ ~1 ~ 2 0.8
