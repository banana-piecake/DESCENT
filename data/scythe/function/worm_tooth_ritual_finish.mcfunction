...
execute at @s run summon ominous_item_spawner ~ ~ ~ {spawn_item_after_ticks:20,item:{id:"minecraft:diamond_sword",count:1,components:{"minecraft:item_model":"scythe:worm_tooth","minecraft:item_name":"Worm Tooth","minecraft:custom_data":{descent:"worm_tooth"},"minecraft:blocks_attacks":{},"minecraft:enchantments":{"angelic_descent:warp_strike":1}}}}
