...
execute at @s run summon ominous_item_spawner ~ ~ ~ {spawn_item_after_ticks:30,item:{id:"minecraft:iron_spear",count:1,components:{"minecraft:item_model":"angelic_descent:ice_dagger","minecraft:enchantments":{"scythe:frozen_blade":1},"!minecraft:kinetic_weapon":{},"minecraft:item_name":"Ice Dagger"}}}
