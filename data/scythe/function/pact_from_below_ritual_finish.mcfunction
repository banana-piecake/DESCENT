...
execute at @s run summon ominous_item_spawner ~ ~ ~ {spawn_item_after_ticks:40,item:{id:"minecraft:echo_shard",count:1,components:{"minecraft:item_model":"scythe:pact_from_below","minecraft:item_name":{"color":"red","text":"Pact From Below"},"minecraft:enchantment_glint_override":true,"minecraft:custom_data":{descent:"pact_from_below"}}}}
