...
execute at @s run summon ominous_item_spawner ~ ~ ~ {spawn_item_after_ticks:60,item:{id:"minecraft:netherite_shovel",count:1,components:{"minecraft:item_model":"scythe:voidtouched_shovel","minecraft:item_name":{"color":"#C4B3FF","text":"Voidtouched Shovel"},"minecraft:enchantments":{"scythe:concussion":1,"scythe:void_cull":1},}}}
