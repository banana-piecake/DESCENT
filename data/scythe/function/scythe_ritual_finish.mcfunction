...
execute at @s run summon ominous_item_spawner ~ ~ ~ {spawn_item_after_ticks:100,item:{id:"minecraft:netherite_axe",count:1,components:{"minecraft:item_model":"scythe:scythe","minecraft:item_name":{"color":"dark_red","text":"Bloodfell Scythe"},"minecraft:lore":["A powerful weapon","end them all..."],"minecraft:enchantments":{"scythe:disarmament":1,"scythe:sonic_dash":1,"scythe:animosity":1,"mending":1},"minecraft:custom_data":{scythe:"scythe"},"minecraft:blocks_attacks":{block_sound:"entity.zombie.attack_iron_door",disabled_sound:"entity.zombie.attack_iron_door"}}}}
