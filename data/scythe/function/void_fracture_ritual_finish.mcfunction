...
execute at @s run summon ominous_item_spawner ~ ~ ~ {spawn_item_after_ticks:20,item:{id:"minecraft:diamond_sword",count:1,components:{"minecraft:item_model":"angelic_descent:void_fracture","minecraft:item_name":"Void Fracture","minecraft:enchantments":{"angelic_descent:fracture":1}}}}
