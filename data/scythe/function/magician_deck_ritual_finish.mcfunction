...
summon ominous_item_spawner ~ ~ ~ {spawn_item_after_ticks:40,item:{id:"minecraft:iron_spear",count:1,components:{"minecraft:max_damage":1200,"!minecraft:kinetic_weapon":{},"minecraft:item_model":"scythe:magician_deck","minecraft:item_name":"Magician's Deck","minecraft:enchantments":{"scythe:bloom":1,"scythe:bloom_weapons/spectral_draw":1},"minecraft:attack_range":{min_reach:0.0,max_reach:0,min_creative_reach:0.0,max_creative_reach:0,hitbox_margin:0},"minecraft:lore":[{"color":"#BDFFF8","italic":false,"shadow_color":12451832,"text":"Flourishing Boon : Shotgun Burst"}],"minecraft:max_damage":1200,"minecraft:minimum_attack_charge":1,"minecraft:attribute_modifiers":[{id:"descent:magician_deck_attack_speed",type:"attack_speed",amount:-2.36,operation:"add_value",slot:"mainhand",display:{type:"hidden"}}]}}}
