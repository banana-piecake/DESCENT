...
item modify entity @s container.0 scythe:softener
...
execute at @s run particle dust_color_transition{from_color:[0.000,0.886,0.949],to_color:[0.647,0.831,0.902],scale:4} ~ ~ ~ 1 4 1 0 200 normal
