...
execute at @s run summon ominous_item_spawner ~ ~ ~ {spawn_item_after_ticks:20,item:{id:"minecraft:echo_shard",count:1,components:{"minecraft:item_model":"scythe:sculk_bomb","minecraft:item_name":"Sculk Bomb","minecraft:enchantments":{"scythe:sculk_infused":1},"minecraft:custom_data":{descent:"sculk_bomb_marker"}}}}
